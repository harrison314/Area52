...
public class EventStringMiddleware
{
    private readonly RequestDelegate next;
    private readonly IApiKeyServices apiKeyServices;
    private readonly ILogWriter logWriter;
    private readonly IOptions<Area52Setup> area52Setup;
    private readonly ILogger<EventStringMiddleware> logger;

    public EventStringMiddleware(RequestDelegate next, IApiKeyServices apiKeyServices, ILogWriter logWriter, IOptions<Area52Setup> area52Setup, ILogger<EventStringMiddleware> logger)
    {
        this.next = next;
